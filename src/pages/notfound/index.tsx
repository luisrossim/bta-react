...
function NotFoundPage() {
  return (
    <div className="relative w-screen h-screen bg-white text-neutral-800 overflow-hidden">
      <div
      ...
      <div className="relative z-10 flex justify-center items-center h-full p-6">
        <div className="flex flex-col gap-6 border border-blue-200 p-10 rounded-2xl bg-white/90 shadow-2xl max-w-lg text-center items-center backdrop-blur-md">
          ...
          <p className="text-lg font-light text-neutral-600">Oops! Você caiu em um buraco negro digital</p>
          <p className="text-xs text-neutral-500">A página que você procura não foi encontrada neste universo.</p>
